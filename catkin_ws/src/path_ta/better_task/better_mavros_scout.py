...
class MavrosTestCommon(unittest.TestCase):
    ...
    def setUp(self, uav_id):
        ...
        #----
        self.target_sub = rospy.Subscriber('/scout' + str(self.uav_id) + '/target_point/position', P, self.goal_pos_callback)
        self.scout0_check_sub = rospy.Subscriber('/scout' + str(self.uav_id) + '/mavros/check_mission/stop', Int64, self.scout0_check_callback)
        return
