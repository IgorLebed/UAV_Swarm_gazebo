...
task_list = [
(-957.3915945077315, -855.0138749238104, 30),
(-910.8959478922188, -895.5183857586235, 35),
(-948.4347058273852, -921.3926183544099, 30),
(-875.1556231221184, -947.2644253643230, 35),
(-845.2041011163965, -858.3795844987035, 30),
(-858.6145041380078, -861.4421726837754, 35),
(-919.3042095946148, -895.0775583777577, 30),
(-942.3035844964907, -844.3298955513164, 35),
(-933.9325257679448, -922.8892891705036, 30),
(-889.9556830069050, -887.7070486117154, 35)] 
...
'publisher for tasks'
curr_task_pub0 = rospy.Publisher('/bomber1/uav0_curr_task', PoseStamped, queue_size=1)  # publish waypoint pos
curr_task_pub1 = rospy.Publisher('/bomber2/uav1_curr_task', PoseStamped, queue_size=1)  # publish waypoint pos
curr_task_pub2 = rospy.Publisher('/bomber3/uav2_curr_task', PoseStamped, queue_size=1)  # publish waypoint pos
...
if __name__ == '__main__':
    try:
        ...
        robot_status_sub0 = rospy.Subscriber('/bomber1/uav0_task_bool', Bool, status_callback0)  # sub to robot's done with task
        robot_status_sub1 = rospy.Subscriber('/bomber2/uav1_task_bool', Bool, status_callback1)
        robot_status_sub2 = rospy.Subscriber('/bomber3/uav2_task_bool', Bool, status_callback2)
